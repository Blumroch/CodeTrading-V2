...
for index, row in df.iterrows() :
    #ACHAT
    if row['close'] > row['SMA']  and usdt > 10 :    
        ...
        print(index,",ACHAT,",coin,",FLUX,",row['close'],",",tradeFee)  #Pour CSV  
    # VEND SMA200<SMA600 et que j'ai au moins 0,0001 coin
    elif row['close'] <= row['SMA'] and coin > 0 :
        ...
        print(index,",VEND,",usdt,",BTC,",row['close'],",",tradeFee)  #Pour CSV  
